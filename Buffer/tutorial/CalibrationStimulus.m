...
nSeq=10; % Number of overall repititions (with different target letters)
nRepetitions=5; % Number of repititions of complete alphabet
cueDuration=2; % Cue presentation time
stimDuration=.1; % Stimulus presentation time
interSeqDuration=1; % Between cue and stimuli time
